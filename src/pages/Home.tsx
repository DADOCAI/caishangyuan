...
import typographyImageBase from 'figma:asset/2145e4efd90b06389836e8206ea66f0e40b20e89.png';
import typographyImageBottom from 'figma:asset/9b8d462bb3544bd7ef5f797be7a968ee6c2eda42.png';
import descImage1 from 'figma:asset/7fd55fee59adc5ceaca1c31865f690922447bf76.png';
import descImage2 from 'figma:asset/3ed8b5352fb2066355c1895f695944a1dced2481.png';
import descImage3 from 'figma:asset/8b9fbaef1a71956d0db80a0007c6ccf3f3893e43.png';
import asciiImageBase from 'figma:asset/bba6a9687c6d644288066d1084237b1ececafad3.png';
import asciiImageBottom from 'figma:asset/91aee102210cafb0c5c3f330318b2b5fd924f119.png';
import dotImageBase from 'figma:asset/d00858fed7cf9defbd0e685ee5f86d56bcdc1450.png';
import dotImageBottom from 'figma:asset/7ce6739730ad3f4c57fa92356c5f56358470f9e9.png';
...
const tools = [
  ...
  },
  {
    ...
    title: "光栅效果生成器",
    description:
      "基于网版套色与半色调算法，支持分色、抖动与多通道导出，适配印刷与海报风格。",
    image: typographyImageBase,
    imageAlt: typographyImageBottom,
    category: "RASTER",
    link: "/raster",
...
export function Home() {
  ...
  return (
    <>
      ...
      <main className="pt-32 px-8 pb-8">
        <div className="max-w-6xl mx-auto px-8 lg:px-0 overflow-visible">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 mt-8">
            ...
            <div className="lg:translate-x-[calc((100vw-1280px)/2+1280px/2-50%-20rem)] w-full max-w-[460px] relative group">
              {/* Description Image - Positioned outside on the left */}
              {tools[3].descriptionImage && (
                <div className="absolute top-0 left-[-260px] w-[240px] opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                  <img
                    src={tools[3].descriptionImage}
                    alt="Tool description"
                    className="w-full h-auto group-hover:animate-border-blink"
                    style={{ boxShadow: '0 0 0 1px #3b82f6' }}
                  />
              ...
              <ToolPanel
                ...
                inverted={false}
                toolLabel="光栅效果生成器"
                overlayImage={"/VIPpng.png"}
                requiresVip={true}
                hoverBadgeImage={'/DADODY-02.png'}
              />
            </div>
          </div>
        </div>
      ...
      {/* Feedback Button Below Grid */}
      <div className="px-8 pb-8">
        <div className="max-w-6xl mx-auto px-8 lg:px-0">
          <div className="w-full max-w-[460px] lg:ml-12">
